...
public partial class Admin_Packagerepeater : System.Web.UI.Page
{
    int vcnt;
    public int Pgnm
    {
    ...
    private void FillRepeater()
    {
        ...
        using (Package  obj = new Package())
        {
            ...
            if (txtserch.Text == "")
            {
                ...
                dsR = obj.package_Select_Alldata();
            }
            else
            {
                obj._serch = txtserch.Text.Trim();
                dsR = obj.package_Select_Searchdata ();
            }
    ...
    protected void rptpackage_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("Packageadd.aspx?id=" + e.CommandArgument.ToString());
        }
