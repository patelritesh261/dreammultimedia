<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="cmspagerepeater.aspx.cs" Inherits="Admin_cmspagerepeater" Title="Untitled Page" %>
...
<div id="content">
                                                            ...
                                                            <table width="70%" cellspacing="2" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td align="left" valign="middle">
                                                                        ...
                                                                        <a href="cmspage.aspx" ><img src="images/forms/form_add.png" height="30" width="80" />  </a>
                                                                    </td>
                                                                    <td colspan="3" > </td>
                                                                </tr>
    ...
    <div>
        <asp:Repeater ID="rptrcms" runat="server" 
            onitemcommand="rptrcms_ItemCommand">
            <HeaderTemplate>
            ...
            <ItemTemplate >
                <tr>
                    ...
                    <td class="options-width">
                        <asp:LinkButton  ID="btnedit" runat ="server"  CommandName ="EditData" CommandArgument ='<%# Eval("CID") %>' CssClass="icon-1 info-tooltip" ></asp:LinkButton>  
        ...
        <asp:LinkButton ID="linkprev" runat ="server" 
            PostBackUrl="cmspagerepeater.aspx"  onclick="linkprev_Click"   >Prev</asp:LinkButton>&nbsp;
        
        <asp:LinkButton ID="linknext" runat="server" 
            PostBackUrl ="cmspagerepeater.aspx"  onclick="linknext_Click" >Next</asp:LinkButton> 
        </form> 
    </div></div> </td>
