<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="Bannerrepeter.aspx.cs" Inherits="Admin_Bannerrepeter" Title="Untitled Page" %>
...
<div id="content">
	...
	<tr>
                                                            ...
                                                            <table width="70%" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td align="left" valign="middle" class="grey_text">
                                                                        <strong>Search by Banner Title:</strong>
                                                                    </td>
                                                                    ...
                                                                    <td align="left" valign="middle">
                                                                        ...
                                                                        <a href="banneradd.aspx" ><img src="images/forms/form_add.png" height="30" width="80" />  </a>
                                                                    </td>
                                                                    <td colspan="3" > </td>
                                                                </tr>
        ...
        <asp:Repeater ID="rptbanner" runat="server" 
            onitemcommand="rptbanner_ItemCommand" >
        <HeaderTemplate>
            ...
            <ItemTemplate >
                <tr>
                    ...
                    <td>
                       <img src = "upload/banner/<%# Eval("image")  %>"  height ="50" width="50"/>
                    </td>
                    <td>
                        <%# Eval("rank")  %>
                    </td>
                    ...
                    <td class="options-width">
                        <asp:LinkButton  ID="btnedit" runat ="server"  CommandName ="EditData" CommandArgument ='<%# Eval("BannerID") %>' CssClass="icon-1 info-tooltip" ></asp:LinkButton> 
                        <asp:LinkButton  ID="btndelete" runat ="server" CommandName ="DeleteData" CommandArgument ='<%# Eval("BannerID") %>' CssClass="icon-2 info-tooltip" OnClientClick="return window.confirm('Do you really want to delete this record ?')"></asp:LinkButton> 
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate >
