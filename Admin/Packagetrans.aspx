<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="Packagetrans.aspx.cs" Inherits="Admin_Packagetrans" Title="Untitled Page" %>
...
<div id="content">
	...
	<!--  start page-heading -->
	<div id="page-heading">
		<h1>Package Transacation Listing</h1>
	</div>
	<!-- end page-heading -->
	...
	<tr>
            ...
            <ItemTemplate >
                <tr>
                    ...
                    <td class="options-width">
                        ...
                        <asp:LinkButton  ID="btndelete" runat ="server" CommandName ="DeleteData" CommandArgument ='<%# Eval("ID") %>' CssClass="icon-2 info-tooltip" OnClientClick="return window.confirm('Do you really want to delete this record ?')"></asp:LinkButton> 
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate >
        ...
        <asp:LinkButton ID="linkprev" runat ="server" 
            PostBackUrl="~/Admin/Packagetrans.aspx"  onclick="linkprev_Click"   >Prev</asp:LinkButton>&nbsp;
        
        <asp:LinkButton ID="linknext" runat="server" 
            PostBackUrl ="~/Admin/Packagetrans.aspx"   onclick="linknext_Click" >Next</asp:LinkButton> 
        </form> 
    </div></div> </td>
