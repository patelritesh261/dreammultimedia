<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="Newsrepeter.aspx.cs" Inherits="Admin_Newsrepeter" Title="Untitled Page" %>
...
<div id="content">
                                                            ...
                                                            <table width="70%" cellspacing="2" cellpadding="0">
                                                                <tr>
                                                                    <td align="left" valign="middle" class="grey_text">
                                                                        <strong>Search by News Title:</strong>
                                                                    </td>
                                                                    ...
                                                                    <td align="left" valign="middle">
                                                                        ...
                                                                        <a href="newsadd.aspx"  ><img src="images/forms/form_add.png" height="30" width="80" />  </a> 
                                                                    </td>
                                                                    <td colspan="3" ></td>
                                                                </tr>
    ...
    <th class="table-header-repeat line-left minwidth-1"><a href=""> Full Description</a> </th>
    ...
    <ItemTemplate >
      <tr>
        <td><%# Eval("Title") %></td>
        <td><%# Eval("SDescription")%></td>
        <td><%# Eval("FDescription")  %></td>
        <td><%# Eval("mmddyyyy") %></td>
        <td><%# Eval("Rank") %></td>
        <td><%# Eval("Active")  %></td>
        <td class="options-width">
                        <asp:LinkButton  ID="btnedit" runat ="server"  CommandName ="EditData" CommandArgument ='<%# Eval("NewsID") %>' CssClass="icon-1 info-tooltip" ></asp:LinkButton> 
                        <asp:LinkButton  ID="btndelete" runat ="server" CommandName ="DeleteData" CommandArgument ='<%# Eval("NewsID") %>' CssClass="icon-2 info-tooltip" OnClientClick="return window.confirm('Do you really want to delete this record ?')"></asp:LinkButton> 
                    </td>
      </tr>
    </ItemTemplate>
    <FooterTemplate >
