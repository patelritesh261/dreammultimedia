...
public partial class Admin_Packagetrans : System.Web.UI.Page
{
    int vcnt;
    public int Pgnm
    {
    ...
    private void FillRepeater()
    {
        ...
        using (Package  obj = new Package ())
        {
            ...
            if (txtserch.Text == "")
            {
                ...
                dsR = obj.packagetran_Select_Alldata ();
            }
            else
            {
                obj._serch = txtserch.Text.Trim();
                dsR = obj.packagetran_Select_Searchdata ();
            }
